% Define block styles used later
  ...
  \begin{tikzpicture}[node distance=3cm,thick,scale=0.38, every node/.style={scale=0.38},path image/.style={
    ...
    \node[module=above:seg] (seg) at (4.5, -4.) {\Large \textbf{Segmentation}};
    ...
    \path (seg.north) +(0,+\blockdist) node (bgreg) {\Large \textbf{Image regularization}};

    \begin{scope}[node distance=10cm]
      \node[module] (det) [below right=-2.2cm and 2cm of seg] {\Large \textbf{Features detection}};
    \end{scope}
    ...
    \path (det.west |- det.north) +(.75,0.4) node (bgfea) {\Large \textbf{CADx}};     
    ...
    \begin{scope}[yshift=-33,xshift=-86]
      \transparent{0.6}\draw[path image=../tikzimage/t2-eps-converted-to.pdf] (0,0) rectangle (1.0,1.0);
    \end{scope}
    ...
    \begin{scope}[yshift=-39,xshift=-80]
      \transparent{0.8}\draw[path image=../tikzimage/t2-eps-converted-to.pdf] (0,0) rectangle (1.0,1.0);
      \path (0,0)+(-1.65,0.3) node {\Large \textbf{T$_2$W-MRI}};
    \end{scope}

    \begin{scope}[yshift=-100,xshift=-86]
      \transparent{0.6}\draw[path image=../tikzimage/dce-eps-converted-to.pdf] (0,0) rectangle (1.0,1.0);
    \end{scope}
    ...
    \begin{scope}[yshift=-106,xshift=-80]
      \transparent{0.8}\draw[path image=../tikzimage/dce-eps-converted-to.pdf] (0,0) rectangle (1.0,1.0);
      \path (0,0)+(-1.65,0.3) node {\Large \textbf{DCE-MRI}};
    \end{scope}

    \begin{scope}[yshift=-167,xshift=-86]
      \transparent{0.6}\draw[path image=../tikzimage/dwi1-eps-converted-to.pdf] (0,0) rectangle (1.0,1.0);
    \end{scope}
    ...
    \begin{scope}[yshift=-173,xshift=-80]
      \transparent{0.8}\draw[path image=../tikzimage/dwi1-eps-converted-to.pdf] (0,0) rectangle (1.0,1.0);
      \path (0,0)+(-1.65,0.3) node {\Large \textbf{ADC}};
    \end{scope}

    \begin{scope}[yshift=-234,xshift=-86]
      \transparent{0.6}\draw[path image=../tikzimage/mrsi-eps-converted-to.pdf] (0,0) rectangle (1.0,1.0);
    \end{scope}
    ...
    \begin{scope}[yshift=-240,xshift=-80]
      \transparent{0.8}\draw[path image=../tikzimage/mrsi-eps-converted-to.pdf] (0,0) rectangle (1.0,1.0);
      \path (0,0)+(-1.5,0.3) node {\Large \textbf{MRSI}};
    \end{scope}

    \path (seg.west |- seg.north)+(-2.5, 1.4+\blockdist) node (g) {};
    \path (reg.west |- reg.south)+(-2.5, -1) node (h) {};
