...
\begin{figure}
  ...
  \subfigure[\acs{t2w} feature importance]{
    \includegraphics[width=.45\textwidth]
    {sk_images/feature_importance_t2w_annotated.pdf}
  }
  \hfill
  \subfigure[\acs{adc} feature importance] {
    \includegraphics[width=.45\textwidth]
    {sk_images/feature_importance_adc_annotated.pdf}
  }
  \hspace*{\fill}\\
  \hspace*{\fill}
  \subfigure[\acs{dce} feature importance] {
    \includegraphics[width=.45\textwidth]
    {sk_images/feature_importance_dce_annotated.pdf}
  }
  \hfill
  \subfigure[\acs{mrsi} feature importance]{
    \includegraphics[width=.45\textwidth]
    {sk_images/feature_importance_mrsi_annotated.pdf}
  }
  \hspace*{\fill}
